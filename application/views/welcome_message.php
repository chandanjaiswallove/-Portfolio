					...
					<div class="skills-content content-width">
						...
						<div class="row skills text-center">
							<div class="col-md-3 scroll-animation" data-animation="fade_from_left">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/figma.png" alt="Figma" />
							...
							<div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/framer.png" alt="Framer" />
							...
							<div class="col-md-3 scroll-animation" data-animation="fade_from_top">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/webflow.png" alt="Webflow" />
							...
							<div class="col-md-3 scroll-animation" data-animation="fade_from_right">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/react.png" alt="React" />
							...
							<div class="col-md-3 scroll-animation" data-animation="fade_from_left">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/wordpress.png" alt="WordPress" />
							...
							<div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
								<div class="skill">
									<div class="skill-inner">
										<img src="modules/assets/images/laravel.png" alt="Laravel/PHP" />
							...
							<div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
								<div class="portfolio-item portfolio-full">
									<div class="portfolio-item-inner">
										<a href="modules/assets/images/portfolio1.jpg" data-lightbox="example-1">
											<img src="modules/assets/images/portfolio1.jpg" alt="Portfolio" />
										</a>
					...
					<div class="testimonial-content content-width">
						...
						<div class="testimonial-slider-wrap scroll-animation" data-animation="fade_from_bottom">
							<div class="owl-carousel testimonial-slider owl-theme">
								<div class="testimonial-item">
									<div class="testimonial-item-inner">
										<div class="author d-flex align-items-center">
											<img src="modules/assets/images/testimonial-1.jpg" alt="Testimonial" />
											<div class="right">
												<h3>Paublo Dybala</h3>
								...
								<div class="testimonial-item">
									<div class="testimonial-item-inner">
										<div class="author d-flex align-items-center">
											<img src="modules/assets/images/testimonial-2.jpg" alt="Testimonial" />
											<div class="right">
								...
								<div class="testimonial-item">
									<div class="testimonial-item-inner">
										<div class="author d-flex align-items-center">
											<img src="modules/assets/images/testimonial-3.jpg" alt="Testimonial" />
											<div class="right">
												<h3>Phil Foden</h3>
												<p class="designation">
						...
						<div class="clients-logos">
							...
							<div class="row align-items-center">
								<div class="col-md-3 scroll-animation" data-animation="fade_from_left">
									<img src="modules/assets/images/client-1.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
									<img src="modules/assets/images/client-2.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_top">
									<img src="modules/assets/images/client-3.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_right">
									<img src="modules/assets/images/client-4.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_left">
									<img src="modules/assets/images/client-5.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
									<img src="modules/assets/images/client-6.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_top">
									<img src="modules/assets/images/client-7.png" alt="Client" />
								</div>
								<div class="col-md-3 scroll-animation" data-animation="fade_from_right">
									<img src="modules/assets/images/client-8.png" alt="Client" />
								</div>
							</div>
						</div>
					</div>
