                                                            ...
                                                            <ul>
                                                                <li class="pr-0 pl-0 pb-3 pt-3">
                                                                    <div class="media"><img
                                                                            ...
                                                                            src="modules/assets2/images/other-images/receiver-img.jpg"
                                                                            alt="">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="user-alerts"><img
                                                                        ...
                                                                        src="modules/assets2/images/dashboard/user/5.jpg"
                                                                        alt="user" />
                                                                    <div class="user-name">
                                                                        <div>
                                                                        ...
                                                                        <div>
                                                                            <svg>
                                                                                <use
                                                                                    href="modules/assets2/svg/icon-sprite.svg#more-vertical">
                                                                                </use>
                                                                            </svg>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="user-alerts"><img
                                                                        class="user-image rounded-circle img-fluid me-2"
                                                                        src="modules/assets2/images/dashboard/user/6.jpg"
                                                                        alt="user" />
                                                                    <div class="user-name">
                                                                        <div>
                                                                            <h6><a class="f-w-500 f-14"
                                                        ...
                                                        <ul>
                                                            <li
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="user-alerts flex-shrink-0"><img
                                                                            ...
                                                                            src="modules/assets2/images/dashboard/user/3.jpg"
                                                                            alt="user" /></div>
                                                            ...
                                                            <li
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="user-alerts flex-shrink-0"><img
                                                                            class="rounded-circle img-fluid img-40"
                                                                            src="modules/assets2/images/dashboard/user/7.jpg"
                                                                            alt="user" /></div>
                                                                    <div class="flex-grow-1">
                                                                        <div class="common-space user-id w-100">
                                                                            <div class="common-space w-100"> <a
                                                    ...
                                                    <div class="cart-dropdown mt-4">
                                                        <ul>
                                                            <li class="pr-0 pl-0 pb-3">
                                                                <div class="media"><img
                                                                        class="img-fluid b-r-5 me-3 img-60"
                                                                        src="modules/assets2/images/other-images/cart-img.jpg"
                                                                        alt="">
